...
namespace Example.AzureFunction.xUnit.WindowsTestHelpers;

[SupportedOSPlatform("windows")]
internal static class WindowsDebuggerTools
{
    static List<int>? existingProcessIds = [];
    ...
    public static async Task AttachToProcessAsync(int processId)
    {
        ...
        if (process != null)
        {
            ...
            {
                await waiter;
                var isolatedProcess = FindIsolatedProcess();
